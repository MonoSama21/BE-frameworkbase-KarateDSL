@putMisDatosMiFotoPerfilProfesorPrimaria @dailyTests
...
Background:
    ...
    * def profesorPrimariaToken = result.token
    ...
    @fotoprimaria
Scenario: Validar que el servicio de actualizar mi foto de perfil por el rol Profesor Primaria responde correctamente
